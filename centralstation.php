...
<body>
    ...
    <div class="venue-numbers">
        <div class="number-wrapper">
            <div class="fact">
                <span class="number" data-number="5400">5,400</span>
                <h4 class="title">Square Feet</h4>
            </div>
            <div class="fact">
                <span class="number" data-number="275">275</span>
                <h4 class="title">Cockatil Style</h4>
            </div>
            <div class="fact">
                <span class="number" data-number="170">170</span>
                <h4 class="title">Seated Dinner</h4>
            </div>
            <div class="fact">
                <span class="number" data-number="220">220</span>
            ...
            <div class="product-tabs">
                <div class="bz-verticalTab bz-tab bz-tab-style4">
                    ...
                    <div class="resp-tabs-container">
                        <!-- DESC -->
                        <div>
                            <h4>Central Station: Our Main Event Space</h4>
                            <p>Our stunning 5,400 square foot room main event space features gorgeous natural lighting, exposed brick, original hardwoods, heavy timber beams, and a built-in kitchenette with private catering area. Ideal for all type occasions from corporate to social and everything in between.</p> 
                        </div>
                        <!-- ./DESC -->
                        <!-- INCLUDED -->
                        <div>
                            ...
                            <ul>
                                ...
                                <li>Use of 9’ counter-height wood farm table with 10 padded barstools</li>

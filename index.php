...
<body>
	...
	<!--<div class="slide-home bz-video-bg">
	    ...
	    <div class="full-height container">
	        <div class="content-slide text-center">
                <h1 class="title">The T330 Experience</h1>
                <p class="desc-slide playfair-display text-italic">Open Spaces, City Warmth, Trendy Style</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="section-title title-style4 text-center">
		                <h1 class="title">EXPERIENCE <span>BEST IN CLASS</span></h1>
		                <p class="sub-title playfair-display text-italic">T330 - Atlanta's Premier Intown Venue</p>
		                <span class="hr"></span>
			...
			<figure id="hero2"><img src="images/home/venue_1070x330.jpg" alt=""></figure>
        ...
        <div class="bz-list-provide provide-style1 five-column">
            <div class="item-provide bg1">
                ...
                <div class="content-hover">
                    <h2 class="title-provice">Social Gatherings</h2>
                    <p>Our venue combines an historic landmark with a contemporary loft feel. Here on Marietta Street, we are confident that the exceptional offerings from our hand-selected vendors, featuring a variety of cuisine, styles and price points, will make your event one to remember.</p>
                    <a href="#" class="link-readmore">Learn More <i class="fa fa-long-arrow-right"></i></a>
                </div>
            </div>
            <div class="item-provide bg2">
                <div class="provice-title">
                     <div class="bz-table">
                        <div class="bz-table-cell">
                            <h2>Meetings</h2>
                ...
                <div class="content-hover">
                    <h2 class="title-provice">Meetings</h2>
                    <p>If you want to go beyond the typical hotel conference center for your corporate meeting or event, visit Terminus 330, Atlanta’s newest event space. Our impressive space is ideal for your next corporate function.</p>
                    <a href="#" class="link-readmore">Learn More <i class="fa fa-long-arrow-right"></i></a>
                </div>
            </div>
            <div class="item-provide bg3">
                <div class="provice-title">
                     <div class="bz-table">
                        <div class="bz-table-cell">
                            <h2>Weddings</h2>
    ...
    <div class="section-11">
        <div class="container">
            <div class="col-md-6 col-sm-12 text-center">
                <figure><img src="images/home/history_573x490.jpg" alt="Terminus 330 Building Erected in 1912"></figure>
            </div>
    ...
    <div class="section-video section-video-4 bg-parallax">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="bz-service-image service-style5">
                        ...
                        <figure><img alt="Terminus 330 Main Event Space" src="images/home/main_370x250.jpg"></figure>
                        <div class="desc-service">Our main event space features a beautiful wrought iron entrance that welcomes guests into an impressive open space with original hardwood flooring, exposed brick and tons of natural light.</div>
                ...
                <div class="col-sm-4">
                    <div class="bz-service-image service-style5">
                        <h3>The Cellar</h3>
                        <figure><img alt="The Cellar at Terminus 330" src="images/home/cellar_370x250.jpg"></figure>
                        <div class="desc-service">This hidden gem, located below the main floor, features vintage lounge furniture, stone walls and whimsical lighting throughout.</div>
                        <a style="border-width: 1px; border-color: rgb(232, 232, 232); color: rgb(48, 48, 48);" data-border_width="1px" data-boder_color="#e8e8e8" data-border_hover_color="#5e599d" data-bg="" data-bghover="" data-text_color="#303030" data-text_color_hover="#5e599d" href="#" class="button-custom">SEE MORE</a>
                    </div>
                </div>
    ...
    <div class="section-contact3">
        <div class="container">
            <div class="section-title title-style5 text-center">
                <h2 class="title">Book Your Next Event With Us!</h2>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="bz-contact-info">
                        <div class="icon-contact"><i class="fa fa-location-arrow"></i></div>
                        <div class="contact-info">
                            <h4>TERMINUS 330</h4>
                            <p>330 Marietta St NW, Atlanta<br/> Georgia- United States</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="bz-contact-info">
                        <div class="icon-contact"><i class="fa fa-whatsapp"></i></div>
                        <div class="contact-info">
                            <h4>Skype</h4>
                            <p>terminus330</p>
                            <h4>Phone</h4>
                ...
                <div class="col-sm-4">
                    <div class="bz-contact-info">
                        ...
                        <div class="contact-info">
                            <h4>Event Inquiry</h4>
                            <a href="mailto:events@terminus330.com">events@terminus330.com</a>
                            <h4>Vendor Support</h4>
                            <a href="mailto:shannon.smith@terminus330.com">shannon.smith@terminus330.com</a>
                        </div>
                    </div>
                </div>
            </div>
